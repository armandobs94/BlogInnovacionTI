...
<div class="container">
	...
	<div class="col-md-12 p-titulo"><h1>BLOG DEL AUTOR</h1></div>
    ...
    <?php
        ...
        $post = $data->fetch_array($cPost);

        $num = $data->num_rows($cPost);
        if($num!=0){
                do{ 
    ?>
		...
		<div class="col-md-2 p-izquierda">
			<div id="datosAutor">
                ...
                <div id="pImage" class="text-center"> 
                    <a href="#" class="thumbnail"><img src="<?php echo $salidaImg.$post['foto'] ?>" class="img-circle" alt="myImage" style="width:150px; height:170px;"></a><hr>
                    <p class="text-primary" id="nombreAutor"><a class="blogAutor" data-toggle="tooltip" title="Visita su perfil" href="blogAutor.php?id=<?php echo $row['id_autor']; ?>"> 
                ...
                <p class="text-center" data-toggle="tooltip" title="Da click para ver mis datos">
                	Contáctame: <label> <?php echo $post['correo'] ?> </label>
                </p>
            </div>
        ...
        <div id="comentarios">
            ...
            <div class="well">
                ...
                <?php  
                    ...
                    $mostrar = $data -> fetch_array($coment);
            ...
            <?php 
                }while($mostrar = $data -> fetch_array($coment));
            }
        ?> 
...
<hr>
<?php 
        }while($post=$data->fetch_array($cPost));
    }
?>				
